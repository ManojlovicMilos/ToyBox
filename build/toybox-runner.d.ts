...
export class Runner
{
    ...
    SetResolution(Resolution:Math.Vector, FixedSize?:boolean)
    Run() : void
    Stop() : void
    EngineInit(EngineType:Draw.DrawEngineType, Resolution?:Math.Vector) : void
    AttachEvents() : void
    UpdateScene() : void
    OnRenderFrame() : void
